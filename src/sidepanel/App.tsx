...
import { MessageSquare, Eye, BarChart3, Clock, Settings, SquarePen } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* Header — logo + brand + icon buttons */}
      <header style={{
        display: 'flex',
        alignItems: 'center',
        ...
        {/* Left: logo + brand + new chat */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <CrabLogoAscii />
          <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--crab-accent)', letterSpacing: '-0.01em' }}>Crab</span>
          <div style={{ width: 1, height: 14, background: 'var(--crab-border-strong)', margin: '0 2px' }} />
          <span style={{ fontSize: 12, fontWeight: 500, color: 'var(--crab-text-secondary)', letterSpacing: '-0.01em' }}>Create Skills</span>
          {/* New chat button — only show when chat has content */}
          <button
